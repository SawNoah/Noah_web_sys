...
<div class="bg-white">
  <header class="absolute inset-x-0 top-0 z-50">
    ...
    <div class="relative isolate px-6 pt-14 lg:px-8">
        ...
        <br>
        <div class="form" >
            <form action="cookie/create" method="POST">
            @csrf
                ...
                <div class="border-b border-gray-900/10 pb-12">
                  ...
                  <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-3">
                      ...
                      <div class="mt-2">
                        <input type="text" name="description" id="last-name" autocomplete="family-name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                      </div>
                    </div>
                  </div>
                </div>
